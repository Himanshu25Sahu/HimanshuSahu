export const projectsData = [
  {
    ...
    media: [
      { type: "image", url: "/HimanshuSahu/phome.png?height=400&width=600" },
      { type: "video", url: "/HimanshuSahu/townsqaurevid.mp4?height=400&width=600" },
      { type: "image", url: "/HimanshuSahu/townsqaurepostpage.png?height=400&width=600" },
      { type: "image", url: "/HimanshuSahu/townsquarediscussion.png?height=400&width=600" },
      { type: "image", url: "/HimanshuSahu/townsqauremyprof1.png?height=400&width=600" },
    ],
  ...
  },
  {
    ...
    media: [
      { type: "image", url: "/HimanshuSahu/devsphome.png?height=400&width=600" },
      { type: "video", url: "/HimanshuSahu/devspvid.mp4?height=400&width=600" },
      { type: "image", url: "/HimanshuSahu/devspchat.png?height=400&width=600" },
  ...
  },
  {
    ...
    media: [
      { type: "image", url: "/HimanshuSahu/algoreg.png?height=400&width=600" },
      { type: "video", url: "/HimanshuSahu/algovizvid.mp4?height=400&width=600" },
      { type: "image", url: "/HimanshuSahu/algoreg2.png?height=400&width=600" },
      { type: "image", url: "/HimanshuSahu/algoclass.png?height=400&width=600" },
      { type: "image", url: "/HimanshuSahu/algochat.png?height=400&width=600" },
    ],
  ...
  },
  {
    ...
    media: [
      { type: "image", url: "/HimanshuSahu/gemicook.jpg?height=400&width=600" },
      { type: "image", url: "/HimanshuSahu/gemi2.jpg?height=400&width=600" },
      { type: "image", url: "/HimanshuSahu/gemi3.jpg?height=400&width=600" },
    ],
  ...
  },
  {
    ...
    media: [
      { type: "video", url: "/HimanshuSahu/coridevid.mp4?height=400&width=600" },
